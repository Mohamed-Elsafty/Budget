...
var UIController = (function(){
    ...
    var DOMstrings = {
        inputType: ".add__type",
        inputDescriptoin: ".add__description",
    ...
    return {
        getInput: function(){
            return {
                ...
                description : document.querySelector(DOMstrings.inputDescriptoin).value,
        ...
        addListItem: function(obj, type){
            ...
            //replace the placeholder data with some actual data
        ...
        clearFields: function(){
            ...
            fields = document.querySelectorAll(DOMstrings.inputDescriptoin + ', ' + DOMstrings.inputValue);
